        ...
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
          <Box sx={{ flex: 1, minWidth: 0 }}>
            <Stack direction="row" alignItems="center" gap={0.5} sx={{ mb: 0.2 }}>
              ...
              {tooltipTitle && (
                <CardInfoTooltip title={tooltipTitle} description={tooltipDesc} accent={c} icon={icon} />
              )}
            </Stack>
...
const AiInsights = () => {
  ...
  const fetch = useCallback(async (key, url, setter) => {
    ...
    try {
      const { data } = await axios.get(`${API_BASE_URL}${url}`, { headers });
      setter(data);
    } catch (e) {
      ...
      <Box>
        ...
        <Grid container spacing={2} sx={{ mb: 2.5, width: '100%' }}>
          {[
            ...
            <Grid item xs={6} sm={4} md={2} key={i} sx={{width: {xs: '100%', sm: '48%', md: '30%', lg: '20%'}}}>
            ...
            <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3, height: "100%" }}>
              <CardContent>
                <SectionHeader
                  ...
                  tooltipDesc="A composite score (0–100) reflecting overall business performance based on revenue, return rate, inventory turnover, and customer activity. Higher is better."
                />
                    ...
                    <Stack spacing={0.8}>
                      {[
                        ...
                        <Stack key={label} direction="row" justifyContent="space-between" alignItems="center">
                          <StyledTooltip title={<TooltipContent title={label} description={tip} accent="#00c853" />} arrow placement="left" enterDelay={300}>
                            <Typography variant="caption" color="text.secondary" sx={{ cursor: "help", borderBottom: "1px dashed", borderColor: "divider" }}>{label}</Typography>
                          </StyledTooltip>
            ...
            <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3, height: "100%" }}>
              <CardContent>
                <SectionHeader
                  ...
                  tooltipTitle="Revenue Breakdown"
                  tooltipDesc="Detailed split of your revenue into gross, net, GST, discounts, returns, and pending dues to understand where money goes."
                />
                {isLoading("bizInsights") ? (
                    ...
                    <Grid container spacing={1.5} sx={{ mb: 2 }}>
                      {[
                        ...
                        <Grid item xs={6} key={k.l} sx={{width: {xs: '48%', sm: '30%', md: '20%'}}}>
                          ...
                          >
                            <Box sx={{ p: 1.2, borderRadius: 1.5, background: alpha(k.c, 0.07), border: `1px solid ${alpha(k.c, 0.18)}`, cursor: "help",
              ...
              <CardContent>
                <SectionHeader
                  ...
                  accent="#ff9800"
                  tooltipTitle="Action Items"
                  tooltipDesc="AI-generated prioritized tasks based on your current business metrics. Address these to improve your health score."
                />
          ...
          <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3 }}>
            <CardContent>
              <SectionHeader
                ...
                accent="#ff9800"
                tooltipTitle="AI Key Insights"
                tooltipDesc="Automatically generated observations about your business performance, anomalies, and opportunities based on your sales data."
              />
            ...
            <Grid container spacing={2} sx={{ mb: 2.5 }}>
              <Grid item xs={12} sm={6} md={4}>
                <StyledTooltip
                  ...
                  arrow placement="top" enterDelay={200}
                >
                  <Card elevation={0} sx={{ borderRadius: 3, background: `linear-gradient(135deg, ${alpha("#00bcd4", 0.12)}, ${alpha("#00bcd4", 0.04)})`, border: `1px solid ${alpha("#00bcd4", 0.3)}`, cursor: "help",
                    transition: "box-shadow 0.2s", "&:hover": { boxShadow: `0 4px 20px ${alpha("#00bcd4", 0.2)}` } }}>
                    <CardContent sx={{ textAlign: "center", py: 3 }}>
                      <Typography variant="caption" color="text.secondary" fontWeight={700} textTransform="uppercase" letterSpacing={0.6} display="block">Predicted Revenue</Typography>
                      <Typography variant="h3" fontWeight={900} color="#00bcd4" sx={{ my: 1 }}>{fmtINR(forecast.forecast.predicted_revenue)}</Typography>
                      <Stack direction="row" justifyContent="center" gap={1} sx={{ mb: 1 }}>
                        <Chip icon={forecast.forecast.trend_direction === "upward" ? <TrendingUp fontSize="small" /> : forecast.forecast.trend_direction === "downward" ? <TrendingDown fontSize="small" /> : <TrendingFlat fontSize="small" />}
                          label={forecast.forecast.trend_direction} size="small" sx={{
                            bgcolor: alpha(forecast.forecast.trend_direction === "upward" ? "#00c853" : forecast.forecast.trend_direction === "downward" ? "#d50000" : "#78909c", 0.12),
                            color: forecast.forecast.trend_direction === "upward" ? "#00c853" : forecast.forecast.trend_direction === "downward" ? "#d50000" : "#78909c",
                            fontWeight: 800,
                          }} />
                      </Stack>
                      <Typography variant="caption" color="text.secondary">
                        Range: {fmtINR(forecast.forecast.lower_bound)} – {fmtINR(forecast.forecast.upper_bound)}
                      </Typography>
                      <br />
                      <Typography variant="caption" color="text.secondary">Target month: {forecast.forecast.month}</Typography>
                    </CardContent>
                  </Card>
                </StyledTooltip>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={8}>
                <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3, height: "100%" }}>
                  <CardContent>
                    ...
                    <Grid container spacing={1.5}>
                      {[
                        { l: "Simple Moving Avg", v: fmtINR(forecast.forecast.sma_forecast), pct: "15% weight", c: "#607d8b", tip: "Averages revenue equally across all historical months. Good baseline, ignores trends." },
                        { l: "Weighted Moving Avg", v: fmtINR(forecast.forecast.wma_forecast), pct: "35% weight", c: "#9c27b0", tip: "Gives more weight to recent months. More responsive to recent changes in sales." },
                        { l: "Linear Regression", v: fmtINR(forecast.forecast.linear_trend_forecast), pct: "30% weight", c: "#ff5722", tip: "Fits a trend line through historical data to project the next value. Best for consistent growth/decline patterns." },
                        { l: "Exponential Smooth.", v: fmtINR(forecast.forecast.exponential_forecast), pct: "20% weight", c: "#ff9800", tip: "Uses exponential decay to weight recent months heavily while still considering older data." },
                      ].map((m) => (
                        <Grid item xs={6} sm={3} key={m.l}>
                          <StyledTooltip title={<TooltipContent title={m.l} description={m.tip} accent={m.c} />} arrow placement="top" enterDelay={200}>
                            <Box sx={{ p: 1.5, borderRadius: 2, background: alpha(m.c, 0.06), border: `1px solid ${alpha(m.c, 0.18)}`, textAlign: "center", cursor: "help",
                              transition: "box-shadow 0.15s", "&:hover": { boxShadow: `0 2px 10px ${alpha(m.c, 0.2)}` } }}>
                              <Typography variant="caption" color="text.secondary" display="block" fontWeight={600} fontSize="0.65rem">{m.l}</Typography>
                              <Typography variant="h6" fontWeight={900} color={m.c}>{m.v}</Typography>
            ...
            <Grid container spacing={2} sx={{ mb: 2.5 }}>
                ...
                <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3 }}>
                  <CardContent>
                    <Stack direction="row" alignItems="center" gap={1} sx={{ mb: 1 }}>
                      <Typography variant="subtitle2" fontWeight={800}>Prediction Confidence</Typography>
                      <CardInfoTooltip
                    ...
                    <Stack direction="row" alignItems="center" gap={2} sx={{ mt: 1 }}>
                      <Box sx={{ flex: 1 }}>
                        <LinearProgress variant="determinate" value={forecast.forecast.confidence_score} sx={{
                          height: 10, borderRadius: 5,
                          bgcolor: alpha(theme.palette.divider, 0.3),
                          "& .MuiLinearProgress-bar": {
                            borderRadius: 5,
                            bgcolor: forecast.forecast.confidence_score >= 70 ? "#00c853" : forecast.forecast.confidence_score >= 50 ? "#ff9800" : "#f44336",
                          },
                        }} />
                        <Typography variant="caption" color="text.secondary" sx={{ mt: 0.5, display: "block" }}>
                          Based on {forecast.forecast.months_analyzed} months · Volatility: {forecast.analytics?.revenue_volatility}%
                        </Typography>
                      </Box>
                      <Typography variant="h5" fontWeight={900}
                        color={forecast.forecast.confidence_score >= 70 ? "#00c853" : "#ff9800"}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3 }}>
                  <CardContent>
                    <Stack direction="row" alignItems="center" gap={1} sx={{ mb: 1 }}>
                      <Typography variant="subtitle2" fontWeight={800}>Trend Rate</Typography>
                      <CardInfoTooltip
                    ...
                    <Stack direction="row" alignItems="center" gap={1} sx={{ mt: 1 }}>
                      {forecast.forecast.trend_direction === "upward" ? <ArrowUpward sx={{ color: "#00c853", fontSize: 28 }} /> : forecast.forecast.trend_direction === "downward" ? <ArrowDownward sx={{ color: "#d50000", fontSize: 28 }} /> : <TrendingFlat sx={{ color: "#78909c", fontSize: 28 }} />}
                      <Box>
                        <Typography variant="h5" fontWeight={900} color={forecast.forecast.trend_direction === "upward" ? "#00c853" : forecast.forecast.trend_direction === "downward" ? "#d50000" : "#78909c"}>
                          {pct(forecast.forecast.trend_pct_per_month)}/mo
                        </Typography>
                        <Typography variant="caption" color="text.secondary">Average monthly growth rate</Typography>
                      </Box>
                    </Stack>
                  </CardContent>
                </Card>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card elevation={0} sx={{ border: `2px solid ${primaryColor}`, borderRadius: 3 }}>
                  <CardContent>
                    <Stack direction="row" alignItems="center" gap={1} sx={{ mb: 1 }}>
                      <Typography variant="subtitle2" fontWeight={800}>Best vs Worst Month</Typography>
                      <CardInfoTooltip
                    ...
                    <Stack spacing={0.5} sx={{ mt: 1 }}>
                      <Stack direction="row" justifyContent="space-between">
                        <Stack direction="row" alignItems="center" gap={0.5}>
                          ...
                          <Typography variant="caption" color="text.secondary">Best: {forecast.analytics.best_month.month}</Typography>
                        </Stack>
                        <Typography variant="caption" fontWeight={800} color="#00c853">{fmtINR(forecast.analytics.best_month.revenue)}</Typography>
                      </Stack>
                      <Stack direction="row" justifyContent="space-between">
                        <Stack direction="row" alignItems="center" gap={0.5}>
                          <Box sx={{ width: 8, height: 8, borderRadius: "50%", bgcolor: "#f44336" }} />
                          <Typography variant="caption" color="text.secondary">Worst: {forecast.analytics.worst_month.month}</Typography>
                        </Stack>
                        <Typography variant="caption" fontWeight={800} color="#f44336">{fmtINR(forecast.analytics.worst_month.revenue)}</Typography>
                      </Stack>
                      <Stack direction="row" justifyContent="space-between">
                        <Typography variant="caption" color="text.secondary">Avg Monthly</Typography>
                        <Typography variant="caption" fontWeight={800}>{fmtINR(forecast.analytics.avg_monthly_revenue)}</Typography>
                      </Stack>
                    </Stack>
                  </CardContent>
                </Card>
